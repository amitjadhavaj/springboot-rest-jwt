...
import com.xor.exception.InvalidJwtAuthenticationException;
...
public class JwtTokenProvider {
    ...
    public String resolveToken(HttpServletRequest req) {
        String bearerToken = req.getHeader(Constants.JWT_AUTH_HEADER);
    ...
    public boolean validateToken(String token) {
       try {
            ...
            throw new InvalidJwtAuthenticationException(Constants.JWT_INVALID_EXPIRED_TOKEN);
